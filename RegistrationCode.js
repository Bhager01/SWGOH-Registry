...
const row = new Discord.ActionRowBuilder()
	.addComponents(new ButtonBuilder().setCustomId('Global_Verify_Button').setLabel('Verify').setStyle('Primary'));

let embedDescription
if(comlinkJSON.verified == 'notVerified')
	embedDescription = "Mhanndalorian Bot is a participant in the SWGOH registry of allycodes & Discord IDs. To verify ownership of the allycode registered, "
			 + "set your in game title and portrait to what is shown below & then click verify.  Verification is optional, but ensures no one can register "
		         + "your allycode to  a different ID in the registry."
else
	embedDescription = "Mhanndalorian Bot is a participant in the SWGOH registry of allycodes & Discord IDs.  This allycode is **already verified.** To reverify "
			 + "ownership of the allycode registered, set your in game title and portrait to what is shown below & then click verify.  Verification is "
			 + "optional, but ensures no one can register your allycode to a different ID in the registry."
